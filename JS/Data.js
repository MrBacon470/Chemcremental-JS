...
function load() {
    ...
    if(data.currentUpdate === 'v0.1.0' || data.currentUpdate === 'v0.1.1' || data.currentUpdate === 'v0.1.2' || data.currentUpdate === 'v0.1.3' || data.currentUpdate === 'v0.1.4') {
        alert(`Welcome Back! The Current Version is v0.2.3, If you are seeing this message this update reset all saves older than Beta 2.0 due to major changes that affect all gameplay.`)
        data.currentUpdate = 'v0.2.3'
        //Reset only for Beta delete next update
        noConfirmDelete()
    }
    else if(data.currentUpdate !== 'v0.2.3') {
        alert(`Welcome Back! The current version is v0.2.3`)
        data.currentUpdate = 'v0.2.3' 
    }
    //fixOldSaves()
}
